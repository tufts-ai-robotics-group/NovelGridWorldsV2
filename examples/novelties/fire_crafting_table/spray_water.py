...
class SprayWater(Action):
    ...
    def check_precondition(
        ...
        """
        Checks preconditions of the spray_water action:
        1) The agent is facing an object
        2) The object is the crafting table
        """
        ...
        return correctDirection and (objs[0][0].fire_state == "on_fire")

    def do_action(self, agent_entity: Entity, target_object: Object = None):
        """
        Checks for precondition, then sprays water
        """
        ...
        objs = self.state.get_objects_at(self.temp_loc)
        objs[0][0].acted_upon("spray_water", agent_entity)
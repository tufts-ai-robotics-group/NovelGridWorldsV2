...
NUM_EPISODES = 100
NG2_CONFIG_PATH = (
    "pre_novelty_diarc.json"  # relative to examples folder or absolute path
)
DIARC_PATH = ""
DIARC_CMD = (
...
def init_episode(json_file, EPISODE_COUNT, NUM_EPISODES):
...
init_episode(NG2_CONFIG_PATH, EPISODE_COUNT, NUM_EPISODES)

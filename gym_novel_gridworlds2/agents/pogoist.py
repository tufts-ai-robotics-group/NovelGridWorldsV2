...
class Pogoist(Agent):
    ...
    def policy(self, observation):
        ...
        #             )
        #     elif self.policy_step == 1:
        #         vec = (0, 0)
        #         if self.entity_data.facing == "NORTH":
        #             vec = (-1, 0)
        #         elif self.entity_data.facing == "SOUTH":
        #             vec = (1, 0)
        #         elif self.entity_data.facing == "WEST":
        #             vec = (0, -1)
        #         else:
        #             vec = (0, 1)

        #         new_loc = np.add(vec, self.entity_data.loc)
        #         print(new_loc)
        ...
        #             return action_sets.index("rotate_right")
        #             # need to rotate until we are facing the oak log
        #     elif self.policy_step == 2:
        #         self.policy_step += 1
        #         return action_sets.index("break")
        #     elif self.policy_step == 3:
        #         self.policy_step += 1

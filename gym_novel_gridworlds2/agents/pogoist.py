...
class Pogoist(Agent):
    ...
    def policy(self, observation):
        ...
        # print("state step count: ", self.state._step_count)
        # if self.isMoving:
        #     self.isMoving = False
        ...
        if self.isMoving:
            ...
            if (
                ...
                self.policy_step == 2 or self.policy_step == 6 or self.policy_step == 10
            ):
                self.policy_step += 1
                return action_sets.index("break")
            elif (
                self.policy_step == 3 or self.policy_step == 7 or self.policy_step == 11
            ):
                self.policy_step += 1

...
class StateTestPlacement3D(unittest.TestCase):
    ...
    def testPlaceItem(self):
        ...
        self.assertEqual(state._map[2, 3, 0], obj_type_id)
    ...
    def testPlaceItemOverItem(self):
        ...
        state.place_object("chest", properties={"loc": loc, "state": "floating"})
        obj_type_id2 = state.item_encoder.get_id("chest")

        print(state._map[2,3])

        self.assertEqual(state._map[2, 3, 0], obj_type_id2)
